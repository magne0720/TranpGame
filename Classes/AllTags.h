...
enum NUMBER
{
	ZERO = 0, ONE = 1, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE, TEN, JACK, QUEEN, KING, NUMBER_NUM, JOKER_NUMBER, ITEM_NUMBER
};
//カードのマーク
enum MARK
{
	NONE = 0, SPADE = 1, CLOVER, HEART, DIAMOND, MARK_NUM, JOKER_MARK, ITEM_MARK
};
//カードの位置情報とプレイヤーの選択状況
enum STATE
{
